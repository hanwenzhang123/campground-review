...
router.get('/:id', catchAsync(async (req, res,) => {
    const campground = await Campground.findById(req.params.id).populate('reviews');      //populate the field so we can see the review associated to the campground
    if (!campground) {
...
router.put('/:id', isLoggedIn, catchAsync(async (req, res) => { //update the editing
    const { id } = req.params;
